 ...
 * Recibe los valores con GET mediante URL. A continuación, muestra por pantalla el valor de cada variable, la suma, la resta, la división y la multiplicación.
 */
...
if ($variable2==0){
    ...
    echo "No se puede realizar la operación"."<br>";
} else {
